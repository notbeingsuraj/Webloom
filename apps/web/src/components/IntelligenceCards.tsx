...
function EmptyNote() {
  return (
    <p className="rounded-xl border border-border bg-secondary px-3 py-2.5 text-xs text-muted-foreground">
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="min-w-0">
              ...
              {item.metrics?.length > 0 && (
                <p className="mt-1 text-xs leading-5 text-muted-foreground">Success metrics: {item.metrics.join(', ')}</p>
              )}
            </div>
          </div>
        </li>
